	...
	<div class="container">
		...
		<nav aria-label="パンくずリスト">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page"><span style="color:black;">[アカウント仮登録完了]</span></li>
				<li class="breadcrumb-item"><span style="color:gray;">アカウント本登録完了</span></li>
			</ol>
		</nav>
		<div class="form-group">
			<div class="alert alert-success" role="alert"><strong>アカウント登録が完了しました。</strong> ログインしてください。</div>
			<dl>
				<dt>ユーザー名:</dt>
